                  ...
                  if (response.flag){
                      ...
                      $('.result-note-after').html(
                          '<div class="result-after-note-text">' +
                              ...
                              '<div>2. Чтобы приблизить предварительный расчет к фактическому рекомендуем заполнить опросный лист и отправить нам или обратиться к нам за консультацией</div>' +
                          '</div>'
                          )
                      }
                  }
